          ...
          <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 mb-3">
                ...
                <input type="text" name="username" id="username" class="form-control @error('username') border-danger @enderror" required value="{{ old('username') }}">
            ...
            <div class="mb-3">
              ...
              <div class="form-check">
                <input type="radio" name="role" id="admin" class="form-check-input" value="admin">
                <label for="admin" class="form-check-label">مدير</label>
              </div>
              <div class="form-check">
                <input type="radio" name="role" id="role" class="form-check-input" value="user">
